...
export default function Support() {
  return (
    <>
      ...
      <Header />
      <main className="mx-auto max-w-lg px-5 py-20 sm:py-28">
        <p className="eyebrow mb-4">Get in touch</p>
        <h1 className="font-display text-4xl font-extrabold leading-none tracking-tight sm:text-5xl">Support</h1>
        ...
        <div className="mt-10 flex flex-col gap-4">
          ...
          >
            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-bolic-red/10 text-bolic-red">
            ...
            <div className="min-w-0 flex-1">
              <p className="font-display text-base font-bold tracking-tight">Email</p>
